...
export const SliderContent: React.FC<SliderContentProps> = ({ children, className }) => {
  return <div className={cn("", className)}>{children}</div>;
};

export const SliderWrapper: React.FC<SliderWrapperProps> = ({ children, value, className }) => {
...
export const SliderBtnGroup: React.FC<ProgressBarProps> = ({ children, className }) => {
  return <div className={cn("", className)}>{children}</div>;
};
