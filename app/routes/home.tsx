...
import { drawLoona } from "~/lib/draw-loona";

export const meta: MetaFunction = ({ loaderData }) => {
  return [{ title: "Loona -  Hydrogen" }, { name: "description", content: "Loona - Hydrogen" }];
};
...
async function loadCriticalData({ context, params }: LoaderFunctionArgs) {
  const [featuredCollection, page] = await Promise.all([
